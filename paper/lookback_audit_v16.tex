...
(1)~A validity assessment against 36 criteria identifying six untested assumptions, most critically that the evaluation's story generator never instantiates false beliefs, and fifteen pre-registered experiments testing them.
...
The paper frames its contribution as understanding ``how LMs track beliefs,'' importing Theory of Mind from cognitive science.
...
This audit applies validity criteria developed by the same author; the framework is independently deposited so readers can verify ratings against the stated standards.
