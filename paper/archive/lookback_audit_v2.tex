...
\begin{table}[t]
\centering
\caption{E12: IIA by question framing ($n = 35$ shared pairs). The subspaces specifically respond to belief framing, partially to action recall, and not at all to perspective-free queries about reality or fill completion.}
\label{tab:framing}
\begin{tabular}{lccc}
\toprule
\textbf{Framing} & \textbf{L38} & \textbf{L52} & \textbf{L53} \\
\midrule
Belief (``What does X believe\ldots'') & 1.000 & 1.000 & 1.000 \\
Action recall (``What did X put\ldots'') & 0.886 & 0.400 & 0.057 \\
Reality state (``What is inside\ldots'') & 0.000 & 0.000 & 0.000 \\
Fill completion (``X filled\ldots with'') & 0.000 & 0.000 & 0.000 \\
\bottomrule
\end{tabular}
\end{table}
...
The subspaces achieve IIA $= 0.975$ at both L38 and L52 (L53 $= 0.388$). This \emph{overturns} our pre-registered prediction of IIA $< 0.30$. The pre-committed interpretation: ``the subspace genuinely tracks the character's epistemic state even when it diverges from reality\ldots the strongest possible evidence for the paper's belief tracking interpretation.'' The subspaces trained on stories where belief equals reality generalize to stories where belief and reality diverge.
...
L38 achieves IIA $= 0.988$ and L52 achieves $0.975$ (L53 $= 0.213$). This again \emph{overturns} our prediction of IIA $< 0.30$. The subspaces generalize to knowledge acquired through observation, not just through the character's own actions.
